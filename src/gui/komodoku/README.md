...
To run you need up and running SUDOKU chain daemon built from latest https://github.com/jl777/squishy/tree/FSM and started with valid for your wallet pubkey in `-pubkey=` param.
