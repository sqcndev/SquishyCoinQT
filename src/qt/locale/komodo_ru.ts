...
<context>
    ...
    <message>
        ...
        <translation>К squishy: URI было прикреплено сообщение, которое будет сохранено вместе с транзакцией для вашего сведения. Заметьте: сообщение не будет отправлено через сеть Komodo.</translation>
    </message>
    <message>
        <source>Pay To:</source>
